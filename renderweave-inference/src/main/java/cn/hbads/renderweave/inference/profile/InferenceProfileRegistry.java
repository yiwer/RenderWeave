...
public final class InferenceProfileRegistry {
    ...
    private static final java.util.List<String> LIVE_RESOURCES = java.util.List.of(
            ...
            "inference-profiles/dashscope-qwen37-flash-product-v41-hybrid-generic.json",
            "inference-profiles/dashscope-qwen37-plus-product-v41-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v41-hybrid-generic.json",
            "inference-profiles/dashscope-qwen37-flash-product-v42-hybrid-generic.json",
            "inference-profiles/dashscope-qwen37-plus-product-v42-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v42-hybrid-generic.json",
            "inference-profiles/dashscope-qwen37-flash-product-v43-hybrid-generic.json",
            "inference-profiles/dashscope-qwen37-plus-product-v43-hybrid-generic.json",
            ...
            "inference-profiles/dashscope-qwen38-max-product-v47-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v48-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v49-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v50-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v51-hybrid-generic.json",
            "inference-profiles/dashscope-qwen38-max-product-v52-hybrid-generic.json"
    );
