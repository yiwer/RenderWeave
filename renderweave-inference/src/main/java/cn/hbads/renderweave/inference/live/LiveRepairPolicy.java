...
final class LiveRepairPolicy {
    private static final Set<String> REPAIRABLE_BLOCKERS = Set.of(
            ...
            "VISUAL_PLAN_ROOT_SCHEMA_MISMATCH",
            "VISUAL_PLAN_SCHEMA_MISSING",
            "VISUAL_PLAN_SCHEMA_EVIDENCE_MISSING",
            "VISUAL_PLAN_SCHEMA_UNEXPECTED",
            "VISUAL_PLAN_RELATION_MISSING",
            "VISUAL_PLAN_RELATION_SHAPE_INVALID",
            "VISUAL_PLAN_RELATION_EVIDENCE_MISSING",
            "VISUAL_PLAN_FIELD_MISSING",
            "VISUAL_PLAN_FIELD_SHAPE_INVALID",
            "VISUAL_PLAN_FIELD_EVIDENCE_MISSING",
            "VISUAL_PLAN_FIELD_UNEXPECTED"
    );
