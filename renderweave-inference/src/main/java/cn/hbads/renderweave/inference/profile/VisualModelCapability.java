...
public record VisualModelCapability(
    ...
    void requireCompatible(InferenceProfile profile) {
        ...
        if (!provider.equals(profile.provider()) || !model.equals(profile.model())
                ...
                || "renderweave-inference-pipeline/4.15".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.16".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.17".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.18".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.19".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.20".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.21".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.22".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.23".equals(profile.pipelineVersion())
                || "renderweave-inference-pipeline/4.24".equals(profile.pipelineVersion())
