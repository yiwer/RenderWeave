...
const TARGET = "domain-services/capacity-record-issuance-target-v1.json";
const REPO_TARGET = `.scratch/renderweave-template-v1/${TARGET}`;
const PRIMARY_RESULT = "domain-services/postissuance-primary-result-v1.json";
const INDEPENDENT_RESULT = "domain-services/postissuance-independent-result-v1.json";
const EVIDENCE = "domain-services/domain-services-capacity-postissuance-a2-2026-08-26.json";
...
const evidence = {
  evidenceVersion: "renderweave-domain-services-capacity-postissuance-a2/1.0",
  evidenceId: "DOMAIN_SERVICES_CAPACITY_POSTISSUANCE_A2::2026-08-26::000001",
  status: "PASS",
  ...
  observedFrontier: {
    ...
    totalFormalCaseCount: 58,
    totalFormalOracleCount: 58,
    totalCapacityCandidateCount: 525,
    remainingUnissuedCapacityCaseCount: 513,
    currentPhase: "CAPACITY_BOUNDARY",
    domainServicesExecutable: true,
  },
  sideEffects: {
