...
try {
    ...
    if ($result.reportVersion -ne `
            ...
            -or $result.boundary.wiredProductAxisCount -ne 58 `
            -or $result.boundary.remainingProductAxisCount -ne 7 `
    ...
    Write-Host 'DESIGN_INPUT_EXPRESSION component gate: 195/195 scalar PASS, 58/65 wired'
}
finally {
    Pop-Location
}
