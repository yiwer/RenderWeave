...
try {
    ...
    if ($enginePngIndependent.verifier -ne 'renderweave-engine-png-python-independent/1' `
            ...
            -or $enginePngIndependent.renderedCases -ne 9 `
            -or $enginePngIndependent.unsupportedCases -ne 10 `
            -or $enginePngIndependent.passed -ne 19 `
            -or $enginePngIndependent.total -ne 19 `
            -or $enginePngIndependent.failed -ne 0 `
            -or $enginePngIndependent.checks -ne 61 `
            ...
            -or $enginePngIndependent.enginePngKernel -ne 'PREORDER_FIXED_IDENTITY_FRAME_RECT_PIXEL_ALIGNED_OPAQUE_PNG_KERNEL_UNWIRED' `
