...
try {
    ...
    if ($enginePngIndependent.verifier -ne 'renderweave-engine-png-python-independent/1' `
            ...
            -or $enginePngIndependent.renderedCases -ne 11 `
            -or $enginePngIndependent.unsupportedCases -ne 11 `
            -or $enginePngIndependent.passed -ne 22 `
            -or $enginePngIndependent.total -ne 22 `
            -or $enginePngIndependent.failed -ne 0 `
            -or $enginePngIndependent.checks -ne 70 `
            ...
            -or $enginePngIndependent.enginePngKernel -ne 'PREORDER_DEFINITE_IDENTITY_GROUP_FRAME_STACK_GRID_RECT_PIXEL_ALIGNED_OPAQUE_RECTANGULAR_CLIP_PNG_KERNEL_UNWIRED' `
