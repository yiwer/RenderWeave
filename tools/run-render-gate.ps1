...
try {
    ...
    if ($enginePngIndependent.verifier -ne 'renderweave-engine-png-python-independent/1' `
            ...
            -or $enginePngIndependent.renderedCases -ne 8 `
            -or $enginePngIndependent.unsupportedCases -ne 8 `
            -or $enginePngIndependent.passed -ne 16 `
            -or $enginePngIndependent.total -ne 16 `
            -or $enginePngIndependent.failed -ne 0 `
            -or $enginePngIndependent.checks -ne 52 `
            ...
            -or $enginePngIndependent.enginePngKernel -ne 'AUTHORED_ORDER_MULTI_PIXEL_ALIGNED_OPAQUE_RECT_PNG_KERNEL_UNWIRED' `
