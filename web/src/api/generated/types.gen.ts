...
export type CreateLiveRunRequest = {
    profileId: 'dashscope-qwen37-plus-product-v43-hybrid-generic' | 'dashscope-qwen38-max-product-v43-hybrid-generic' | 'dashscope-qwen37-flash-product-v43-hybrid-generic';
    mode: InferenceMode;
