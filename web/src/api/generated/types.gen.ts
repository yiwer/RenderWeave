...
export type CreateLiveRunRequest = {
    profileId: 'dashscope-qwen37-plus-product-v44-hybrid-generic' | 'dashscope-qwen38-max-product-v44-hybrid-generic' | 'dashscope-qwen37-flash-product-v44-hybrid-generic';
    mode: InferenceMode;
