...
fn assert_honest_boundary(boundary: &Boundary) {
    ...
    assert_eq!(
        "PREORDER_DEFINITE_IDENTITY_GROUP_FRAME_STACK_GRID_COMPOSITION_VIEWPORT_SOURCE_CANVAS_BACKGROUND_CONTAIN_CENTER_HOST_SOURCE_HARD_CLIP_RECT_PIXEL_ALIGNED_SOLID_ALPHA_PREMULTIPLIED_SOURCE_OVER_SUBTREE_OPACITY_ROUND_HALF_UP_ISOLATION_RECTANGULAR_CLIP_VISIBILITY_ZERO_OPACITY_SUPPRESSION_PNG_KERNEL_PROFILE_GATED",
